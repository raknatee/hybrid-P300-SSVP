...
const ssvpConfig:HYPSCommands = {
    cmds:[
        ...
        {cmd:CommandType.target,details:{gridIndex:0,alpIndex:4},repeat:3},
        {cmd:CommandType.target,details:{gridIndex:1,alpIndex:4},repeat:3},
        {cmd:CommandType.target,details:{gridIndex:2,alpIndex:4},repeat:3},
        {cmd:CommandType.target,details:{gridIndex:3,alpIndex:4},repeat:3},
