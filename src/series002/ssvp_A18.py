...
from module.experiment_info import ATTEMPT18
...
SAMPLING_RATE = ATTEMPT18.headset_info.sampling_rate
# SAMPLING_RATE = 240
def main():
    ...
    def load()->list[SSVPDataWithLabel]:
        ...
        return compose_ssvp_dataset(eeg_docs,experiment_docs,ATTEMPT18,(5,20),[0,1,2])
