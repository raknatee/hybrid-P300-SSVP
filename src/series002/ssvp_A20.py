...
from module.experiment_info import ATTEMPT20
...
SAMPLING_RATE = ATTEMPT20.headset_info.sampling_rate
# SAMPLING_RATE = 240
def main():
    ...
    def load()->list[SSVPDataWithLabel]:
        ...
        return compose_ssvp_dataset(eeg_docs,experiment_docs,ATTEMPT20,(1,100),[0,1,2])
