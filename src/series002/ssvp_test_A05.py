...
from module.experiment_info import ATTEMPT5
...
def main():
    eeg_docs = get_eeg_docs("A05S01")
    experiment_docs = get_experiment_docs("A05S01")
   
    compose_ssvp_dataset(eeg_docs,experiment_docs,ATTEMPT5,[0,1,2],debug=True)
