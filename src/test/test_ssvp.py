...
def test_get_ssvp_dataset_A07():
    ...
    list_ssvp = compose_ssvp_dataset(eeg_docs,experiment_docs,ATTEMPT7,(1,30),selected_eeg_channels=[0,1,2])
...
def test_get_ssvp_dataset_A06():
    ...
    list_ssvp = compose_ssvp_dataset(eeg_docs,experiment_docs,ATTEMPT6,(1,30),selected_eeg_channels=[0,1,2])
    assert len(list_ssvp) == 10
    for ssvp in list_ssvp:
        assert 230 <=  ssvp.eeg.shape[0] < 310
        assert ssvp.eeg.shape[1] == 3
...
def test_get_ssvp_dataset_A02():
    ...
    list_ssvp = compose_ssvp_dataset(eeg_docs,experiment_docs,ATTEMPT2,(1,30),selected_eeg_channels=[0,1,2])
...
def test_get_ssvp_dataset_A01():
    ...
    for p_id in ["A01S01","A01S02","A01S03"]:
        ...
        list_ssvp = compose_ssvp_dataset(eeg_docs,experiment_docs,ATTEMPT1,(1,30))
