...
def test_load_data():
    ...
    data_with_data_clearning = P300DataFilter(compose_p300_dataset(eeg_docs,experiment_docs,ATTEMPT2,[3,4,5,6],eeg_transform_func=eeg_to_img)).balance_class().shuffle().done()
